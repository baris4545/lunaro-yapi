  ...
  return (
    <>
      ...
      >
        ...
        {/* Gallery: kaydırma serbest, item'a basınca lightbox */}
    ...
    <View style={styles.aboutCard}>
      ...
      <View style={{ marginTop: 14 }}>
        <Text style={styles.aboutText}>
          Yıllara dayanan sektör tecrübesiyle konut üretimi alanında faaliyet gösteren firmamız, modern mimari anlayışı
          ve kaliteli yapı standartlarını temel alarak projeler geliştirmektedir. Amacımız; sadece konut değil, uzun
          yıllar güvenle yaşanabilecek, değerini koruyan yaşam alanları üretmektir.
        </Text>

        <Text style={styles.aboutText}>
          Projelerimizde fonksiyonel planlama, kaliteli malzeme kullanımı ve güçlü teknik altyapı önceliğimizdir.
          Yüksek tavanlı, ferah yaşam alanları; akıllı ev sistemleri, yerden ısıtma ve çağdaş mühendislik çözümleriyle
          desteklenmektedir.
        </Text>

        <Text style={styles.aboutText}>
          Her projede aile yaşamına uygun, konforlu ve güvenli mekânlar oluşturmayı hedeflerken; yatırım açısından da
          sürdürülebilir ve değer kazanan yapılar inşa etmeye özen gösteriyoruz. Planlama aşamasından teslim sürecine
          kadar şeffaf, ulaşılabilir ve çözüm odaklı bir yaklaşım benimsiyoruz.
        </Text>

        <Text style={[styles.aboutText, styles.aboutTextLast]}>
          Güvenilir yapılar, doğru lokasyonlar ve modern yaşam anlayışıyla geleceğe değer katan projeler üretmeye devam
          ediyoruz.
        </Text>
      </View>
...
const styles = StyleSheet.create({
  ...
  ctaRow: { marginTop: 16, flexDirection: "row", flexWrap: "wrap", gap: 10 },
  primaryBtn: {
    flexDirection: "row",
    alignItems: "center",
    gap: 8,
  ...
  sectionCapRow: { flexDirection: "row", alignItems: "center", gap: 10 },
  sectionChip: {
    flexDirection: "row",
    alignItems: "center",
    gap: 8,
  ...
  linkBtn: { flexDirection: "row", alignItems: "center", gap: 4, paddingVertical: 8, paddingHorizontal: 8 },
  linkText: { color: "rgba(229,231,235,0.72)", fontWeight: "900" },
  ...
  aboutHead: { flexDirection: "row", gap: 14, alignItems: "flex-start" },
  ...
  aboutCtaText: { color: "#0b0f14", fontWeight: "900" },
